...
function _applyTranslations() {
  ...
  var valueUtilityQlWatermark = document.getElementById("ql-remove-watermark");
  if (valueUtilityQlWatermark) valueUtilityQlWatermark.innerHTML = "🚫 <span>" + t("btn.watermark") + "</span>";
  ...
  var valueUtilitySpWatermark = document.getElementById("sp-remove-watermark");
  if (valueUtilitySpWatermark) valueUtilitySpWatermark.innerHTML = "🚫 <span>" + t("btn.watermark") + "</span>";
